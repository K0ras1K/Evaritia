...
class ContainerStandartNeutron(player: InventoryPlayer, machine: TileEntityStandartNeutron) : Container() {
    val tileEntityStandartNeutron = machine
    ...
    override fun canInteractWith(entityPlayer: EntityPlayer): Boolean {
        return tileEntityStandartNeutron.isUseableByPlayer(entityPlayer)
    }
