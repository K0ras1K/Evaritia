...
class BlockImprovedNeutron(block_name: String): BlockContainer(Material.iron) {
    ...
    override fun registerBlockIcons(iconRegister: IIconRegister) {
        top = iconRegister.registerIcon("evaritia:improved_neutron_top")
        sides = iconRegister.registerIcon("evaritia:improved_neutron_side")
        front = iconRegister.registerIcon("evaritia:improved_neutron_front")
    }
    ...
    override fun getIcon(world: IBlockAccess?, x: Int, y: Int, z: Int, side: Int): IIcon? {
        return if (side == 1) {
            ...
            var facing = 2
            val machine = world!!.getTileEntity(x, y, z) as TileEntityImprovedNeutron
            if (machine != null) {
    ...
    override fun createNewTileEntity(world: World, meta: Int): TileEntity {
        return TileEntityImprovedNeutron()
    }
    ...
    override fun onBlockActivated(world: World, x: Int, y: Int, z: Int, player: EntityPlayer, par6: Int, par7: Float, par8: Float, par9: Float): Boolean {
        return if (world.isRemote) {
            ...
            player.openGui(Evaritia.instance(), 2, world, x, y, z)
            true
        }
    }

    override fun breakBlock(world: World, x: Int, y: Int, z: Int, block: Block?, wut: Int) {
        val collector = world.getTileEntity(x, y, z) as TileEntityImprovedNeutron
        if (collector != null) {
